  ...
  return (
    <div>
        ...
        <div>
            ...
            />
            <p className="text-[14px] text-[#A1A1A1] italic ">
            Maximum order per gift card
            </p>
          </div>
          <div className="mt-3">
            <label htmlFor="" className="text-[14px] text-black ">
            ...
            />
            <p className="text-[14px] text-[#A1A1A1] italic ">
            Total sum of money in all 4 accounts cannot exceed this sum
            </p>
          </div>
        </div>
        <div className="flex flex-col w-1/2 mt-10">
          <p className='text-[14px]'>Update Transaction Limit</p>
...
export default VerifiedUserForm