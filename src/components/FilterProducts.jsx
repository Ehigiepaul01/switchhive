...
const FilterProducts = () => {
  return (
    ...
    >
      <button className="relative px-4 py-2 mb-4 text-white bg-blue-500 border border-transparent rounded-md">
        <span><img src={filter} alt="" className="absolute inset-0 pl-3 my-auto" /></span>
        Filter By
      </button>
          ...
          <h3 className="mb-2 text-blue-500">
            <span className="pr-10">
              <img
                src={check}
                alt=""
                className="absolute inset-0 pl-3 my-auto"
              />
            </span>
            Gift Card
          </h3>
