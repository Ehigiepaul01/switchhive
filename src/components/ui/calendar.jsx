  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day_range_start:
          "day-range-start border-blue-900 border-2 aria-selected:bg-slate-100/50 aria-selected:text-slate-900 dark:aria-selected:bg-slate-800/50 dark:aria-selected:text-slate-50",
        day_range_end: "day-range-end  border-blue-900 border-2 aria-selected:bg-slate-100/50 aria-selected:text-slate-900 dark:aria-selected:bg-slate-800/50 dark:aria-selected:text-slate-50",
        day_selected:
          "bg-slate-900 rounded-full text-slate-50 hover:bg-slate-900 hover:text-slate-50 focus:bg-slate-900 focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
